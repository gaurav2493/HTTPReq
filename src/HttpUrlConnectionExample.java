...
public class HttpUrlConnectionExample {
  ...
  public static void main(String[] args) throws Exception {
	...
	String url = "http://210.212.85.155/login/index.php";
	String gmail = "http://210.212.85.155/notice/notices.php";
	...
	String postParams = http.getFormParams(page, "11it056", "9013669956");
	...
	while(true)
	{
		...
		{
			String result = http.GetPageContent(gmail+"?start="+(pageno-1)*15);
			//System.out.println(result);
			http.parseNoticeTable(result);
		}
	}
	sc.close();
	
  }
  private void parseNoticeTable(String htmlTableContent)
  {
